...
_test_lines = [
    "assert candidate([['A', 'B'], ['C', 'D']], 'BD') == True",
    "assert candidate([['A', 'B'], ['C', 'D']], 'AC') == True",
    "assert candidate([['A', 'B', 'C', 'E'], ['S', 'F', 'C', 'S'], ['A', 'D', 'E', 'E']], 'ABCB') == False",
    "assert candidate([['A', 'B', 'C', 'E'], ['S', 'F', 'C', 'S'], ['A', 'D', 'E', 'E']], 'ASADB') == False",
    "assert candidate([['A', 'B', 'C', 'E'], ['S', 'F', 'C', 'S'], ['A', 'D', 'E', 'E']], 'ABCB') == False",
    "assert candidate([['A', 'B', 'C', 'E'], ['S', 'F', 'E', 'S'], ['A', 'D', 'E', 'E']], 'ABCESEEEFS') == True",
    "assert candidate([['A', 'B', 'C', 'E'], ['S', 'F', 'C', 'S'], ['A', 'D', 'E', 'E']], 'Z') == False",
    "assert candidate([['A', 'B', 'C', 'E'], ['S', 'F', 'C', 'S'], ['A', 'D', 'E', 'E']], 'AB') == True",
    "assert candidate([['A', 'B', 'C', 'E'], ['S', 'F', 'C', 'S'], ['A', 'D', 'E', 'E']], 'ABCCED') == True",
    "assert candidate([['A', 'B', 'C', 'E'], ['S', 'F', 'C', 'S'], ['A', 'D', 'E', 'E']], 'SEE') == True",
    "assert candidate([['A', 'B', 'C', 'E'], ['S', 'F', 'C', 'S'], ['A', 'D', 'E', 'E']], 'E') == True",
    "assert candidate([['A', 'B', 'C', 'E'], ['S', 'F', 'C', 'S'], ['A', 'D', 'E', 'E']], 'SEE') == True",
    "assert candidate([['A', 'B'], ['C', 'D']], 'AB') == True",
    "assert candidate([['A', 'B'], ['C', 'D']], 'CD') == True",
    "assert candidate([['A', 'B', 'C', 'E'], ['S', 'F', 'C', 'S'], ['A', 'D', 'E', 'E']], 'ASAD') == True",
